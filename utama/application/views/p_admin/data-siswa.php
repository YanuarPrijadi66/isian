	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1 class="hit-the-floor"><b><i>Data Siswa</i></b></h1>
			<ol class="breadcrumb">
				<li>
					<a href="home">
				...
				<li class="active">
					<img src="<?php echo base_url();?>utama/assists/images/icons/community.ico" width=24 height=24> Data Siswa
				</li>
			</ol>
		</section>
		<!-- Main content -->
		<section class="content">
            <div class="row" id="idDataSiswa"></div>
